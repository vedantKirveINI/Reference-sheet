...
const NODE_SUGGESTIONS = {
  HTTP: ["TRANSFORMER", "IF_ELSE_V2", "ITERATOR", "TINY_GPT"],
  WEBHOOK: ["TRANSFORMER", "IF_ELSE_V2", "HTTP", "FIND_ALL"],
  TRANSFORMER: ["IF_ELSE_V2", "HTTP", "ITERATOR", "FIND_ALL"],
  IF_ELSE_V2: ["HTTP", "TRANSFORMER", "SEND_EMAIL", "SLACK"],
  ITERATOR: ["HTTP", "TRANSFORMER", "UPSERT", "IF_ELSE_V2"],
  FIND_ALL: ["ITERATOR", "TRANSFORMER", "IF_ELSE_V2", "AGGREGATOR"],
  TINY_GPT: ["TRANSFORMER", "IF_ELSE_V2", "HTTP", "SEND_EMAIL"],
  FORM_TRIGGER: ["TRANSFORMER", "IF_ELSE_V2", "HTTP", "SEND_EMAIL"],
  MANUAL_TRIGGER: ["HTTP", "FIND_ALL", "TRANSFORMER", "TINY_GPT"],
  SCHEDULE_TRIGGER: ["HTTP", "FIND_ALL", "TRANSFORMER", "ITERATOR"],
  TABLE_TRIGGER: ["TRANSFORMER", "IF_ELSE_V2", "HTTP", "UPSERT"],
};

const SUGGESTION_REASONS = {
  HTTP: "Make an API call",
  TRANSFORMER: "Transform the data",
  IF_ELSE_V2: "Add a condition",

...
import { ODSIcon as Icon, ODSTooltip as Tooltip, ODSLabel as Label } from "../../../../index.jsx";
import styles from "./index.module.css";
import { NODE_VARIABLES } from "../../constants/types";
...
export function SchemaList({
  ...
  const handleClick = (e, isRawData = false) => {
    ...
    const nodeName = parentContext?.nodeName || node.description || node.name;

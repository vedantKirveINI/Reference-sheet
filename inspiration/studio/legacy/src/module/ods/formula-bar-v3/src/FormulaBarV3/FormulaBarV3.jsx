...
import FxPopperV3 from "./FxPopperV3";
import { validateFormula } from "../engine";
  ...
  (
    ...
    const functionRegistry = useMemo(() => {
      ...
      const allFunctionData = [
        require("../data/arithmetic-data").arithmeticData,
        require("../data/text-data").textData,
        require("../data/logical-data").logicalData,
        require("../data/date-data").dateData,
        require("../data/array-data").arrayData,
        require("../data/other-data").otherData,
      ];

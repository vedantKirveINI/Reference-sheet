...
import { ODSLabel as Label } from "../../../../index.jsx";
...
import GridDataBlocks from "./GridDataBlocks";
import NodeVariableSection from "../node-variable-section";
import TableColumnsSection from "../table-variable-section";
const Section = ({
  data,
  isVerbose = false,
  isFiltered = false,

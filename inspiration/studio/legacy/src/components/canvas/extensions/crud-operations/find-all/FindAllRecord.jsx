  ...
  (
    ...
    const getData = useCallback(() => {
      return {
        ...
        table,
        record,
        label: data?.label || FIND_ALL_RECORD_NODE.name,
        filter,
        whereClause,
        orderBy,
        orderByClause,
      ...
      return [
        ...
        },
        {
          ...
          panelComponentProps: {
            ...
            projectId,
            parentId,
            node: nodeData || FIND_ALL_RECORD_NODE,
            onTestComplete: () => {
    ...
    return (
      // <div className={classes["find-all-record-container"]}>
      //   <TextField
      //     label="Label"
      ...
      //     }}
      //   >
      //     <ODSTab variant="standard" tabData={findAllRecordTabData} />
      //   </div>
      // </div>
      <TabContainer
        tabs={tabs || []}
        colorPalette={{
          dark: FIND_ALL_RECORD_NODE.dark,
          light: FIND_ALL_RECORD_NODE.light,
          foreground: FIND_ALL_RECORD_NODE.foreground,
        }}
        hasTestTab={FIND_ALL_RECORD_NODE.hasTestModule}
        onTest={() => {

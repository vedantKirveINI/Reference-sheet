  ...
  (
    ...
    const saveHandler = useCallback(
      (openNodeAfterCreate = true) => {
        ...
        onSave(
          findAllRecord,
          {
            // name: findAllRecord?.label || FIND_ALL_SHEET_RECORD_NODE.name,
    ...
    return (
      ...
      <CommonDrawer
        ...
        title={{
          name: nodeData?.name || FIND_ALL_SHEET_RECORD_NODE.name,
          icon: nodeData?._src || FIND_ALL_SHEET_RECORD_NODE._src,
          foreground:
            nodeData?.foreground || FIND_ALL_SHEET_RECORD_NODE.foreground,
          background:
            nodeData?.background || FIND_ALL_SHEET_RECORD_NODE.background,
          hoverDescription: nodeData?.hoverDescription,
        }}
        node={FIND_ALL_SHEET_RECORD_NODE}
        onAddNode={onAddNode}

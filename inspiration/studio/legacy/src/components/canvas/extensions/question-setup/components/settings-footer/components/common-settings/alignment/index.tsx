...
import {
  getAlignmentTabContainerStyle,
  getAlignmentTabsContainerStyle,
  getQuestionAlignmentContainerStyles,
  getQuestionAlignmentTextStyles,
} from "./styles";
...
const QuestionAlignment = ({
  ...
  const isQuestionLeftAlign =
    mode === Mode.CARD
      ...
      : true;
  return (
    <div css={getQuestionAlignmentContainerStyles(style, disabled)}>
      <div
        css={getAlignmentTabsContainerStyle({ mode, disabled })}
        data-testid="settings-question-alignment-tabs"
      >
        <div
          css={getAlignmentTabContainerStyle({

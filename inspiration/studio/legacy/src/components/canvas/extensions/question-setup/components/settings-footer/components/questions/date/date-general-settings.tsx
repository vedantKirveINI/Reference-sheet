...
import { ODSLabel, ODSAutocomplete as ODSAutoComplete } from "@src/module/ods";
...
const DateGeneralSettings = ({
  ...
  return (
    <div css={styles.container} data-testid="date-general-settings">
      ...
      <div css={styles.wrapperContainer}>
        <div css={styles.dateFormatWrapper}>
          <div css={styles.autocompleteWrapper}>

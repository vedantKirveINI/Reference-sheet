    ...
    <div className="space-y-8">
      <div className="text-center space-y-4">
        <div className="mx-auto w-16 h-16 bg-[#22C55E]/10 rounded-2xl flex items-center justify-center">
          <img src={tinyTablesUpdateIcon} alt="Update Records" className="w-8 h-8" />
        </div>
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">Update Records</h2>
          <p className="text-gray-500 mt-2 max-w-md mx-auto">
            Bulk update multiple rows matching your conditions
          </p>
        </div>
      </div>
        ...
        <>
          <div className="bg-gray-50 rounded-xl p-4 space-y-3">
            <h3 className="font-medium text-gray-900 flex items-center gap-2">
              ...
              When to use Update Records
            </h3>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start gap-2">
                <span className="text-[#22C55E] mt-0.5">•</span>
                <span><strong>Bulk status change</strong> — Mark all pending orders as shipped</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#22C55E] mt-0.5">•</span>
                <span><strong>Mass update</strong> — Apply price changes to all products in a category</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#22C55E] mt-0.5">•</span>
                <span><strong>Batch processing</strong> — Update all records matching specific criteria</span>
              </li>
            </ul>
          </div>

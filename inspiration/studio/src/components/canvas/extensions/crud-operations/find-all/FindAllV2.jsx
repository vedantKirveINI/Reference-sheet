...
import { FIND_ALL_V2_NODE, MYSQL_FIND_ALL_RECORD_NODE, POSTGRES_FIND_ALL_RECORD_NODE, TABS, THEME } from "./constants";
import { useFindAllV2State } from "./hooks/useFindAllV2State";
...
const FindAllV2 = forwardRef(
  (
    ...
    const state = useFindAllV2State(data, workspaceId, projectId);
    ...
    const selectedNode = useMemo(() => {
      if (effectiveDatabaseType === DATABASE_TYPES.MYSQL) {
        return MYSQL_FIND_ALL_RECORD_NODE;
      }
      if (effectiveDatabaseType === DATABASE_TYPES.POSTGRESQL) {
        return POSTGRES_FIND_ALL_RECORD_NODE;
      }
      return FIND_ALL_V2_NODE; // fallback
    ...
    const getFooterGuidance = () => {
      ...
      if (activeTab === TABS.CONFIGURE) {
        return "Configure your query options, then test";
      }
        ...
        case TABS.TEST:
          return (
            <CommonTestModuleV3
              ...
              parentId={parentId}
              variables={variables}
              node={nodeData || FIND_ALL_V2_NODE}
    ...
    return (
      <WizardDrawer
        ...
        subtitle={FIND_ALL_V2_NODE.description}
        tabs={tabs}
        activeTab={activeTab}
...
FindAllV2.displayName = "FindAllV2";

export default FindAllV2;

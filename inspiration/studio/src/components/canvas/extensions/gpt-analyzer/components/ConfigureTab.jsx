    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <FormSection
          ...
          description="Define how the AI should analyze data"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., You are an expert data analyst that specializes in..."
        ...
        <FormSection
          ...
          description="What should the AI analyze? Use {{data}} to insert variables"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., Analyze the following data and identify patterns..."
        ...
        <FormSection
          title="Output Schema"
          description="Define what analysis results the AI should return"
          required
            ...
            <div className="mt-4 space-y-4 p-4 bg-gray-50 rounded-xl">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  Lower values = more focused analysis, higher values = more creative insights
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-400">
                  Maximum length of the analysis response
                </p>
              </div>
            </div>
          )}

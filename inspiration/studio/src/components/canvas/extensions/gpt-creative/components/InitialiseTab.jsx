...
import { Megaphone, Share2, ShoppingBag, Mail } from "lucide-react";
import { CREATIVE_TEMPLATES } from "../constants";
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-2 max-w-md mx-auto">
            Generate creative content and copy with AI
          </p>
        </div>
      </div>

      <div className="bg-pink-50 rounded-xl p-4">
        <h3 className="text-sm font-medium text-pink-900 mb-3">When to use</h3>
        <div className="grid grid-cols-2 gap-2">
          <UseCaseItem icon={Megaphone} text="Marketing copy" />
          <UseCaseItem icon={Share2} text="Social content" />
          <UseCaseItem icon={ShoppingBag} text="Product descriptions" />
          <UseCaseItem icon={Mail} text="Email campaigns" />
        </div>
      </div>

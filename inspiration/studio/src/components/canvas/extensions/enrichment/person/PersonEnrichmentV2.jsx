...
import { User, SlidersHorizontal, Settings, Play } from "lucide-react";
...
import { PERSON_ENRICHMENT_V2_NODE, TABS, THEME } from "./constants";
import { usePersonEnrichmentState } from "./hooks/usePersonEnrichmentState";
...
const PersonEnrichmentV2 = forwardRef(
  (
    {
      canvasRef,
      annotation,
    ...
    const getFooterGuidance = () => {
      ...
      if (activeTab === TABS.CONFIGURE) {
        ...
        return "Enter the person's name and company domain, then test the enrichment";
      }
        ...
        case TABS.TEST:
          return (
            <CommonTestModuleV3
              ...
              parentId={parentId}
              variables={variables}
              node={nodeData || PERSON_ENRICHMENT_V2_NODE}
    ...
    return (
      <>
        <WizardDrawer
          ...
          title={data.name || state.name || "Person Enrichment"}
          subtitle="Get information about a person using name and company domain"
          tabs={tabs}
          activeTab={activeTab}
...
PersonEnrichmentV2.displayName = "PersonEnrichmentV2";

export default PersonEnrichmentV2;

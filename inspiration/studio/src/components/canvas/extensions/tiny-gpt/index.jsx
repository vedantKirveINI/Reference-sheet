...
import { TINYGPT_NODE } from "./constants";
import TinyGPTV3 from "./TinyGPTV3";

const TinyGPTV3Dialog = forwardRef(
  (
    {
      canvasRef,
      annotation,
    ...
    const saveHandler = useCallback(
      (openNodeAfterCreate = true) => {
        const gptData = ref.current?.getData();
        onSave(gptData, {}, openNodeAfterCreate);
      },
      [onSave, ref]
    );
...
TinyGPTV3Dialog.displayName = "TinyGPTV3Dialog";

export default TinyGPTV3Dialog;

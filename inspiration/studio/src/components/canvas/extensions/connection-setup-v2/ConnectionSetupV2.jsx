...
import { CONNECTION_SETUP_V2_NODE } from "./constants";
import { useConnectionState } from "./hooks/useConnectionState";
import InitialiseTab from "./components/InitialiseTab";
import ConfigureTab from "./components/ConfigureTab";

const ConnectionSetupV2 = forwardRef(
  (
    {
      canvasRef,
      annotation,
    ...
    const tabs = [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          parentId,
          variables,
          node: nodeData || CONNECTION_SETUP_V2_NODE,
    ...
    return (
      <TabContainer
        ...
        tabs={tabs}
        colorPalette={{
          dark: CONNECTION_SETUP_V2_NODE.dark,
          light: CONNECTION_SETUP_V2_NODE.light,
          foreground: CONNECTION_SETUP_V2_NODE.foreground,
        }}
        onSave={onSave}
        hasTestTab={CONNECTION_SETUP_V2_NODE.hasTestModule}
...
export default ConnectionSetupV2;

...
import { Bot, Search, Cog, Zap } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-8">
      <div className="text-center space-y-4">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">Agent</h2>
      ...
      <div className="bg-gray-50 rounded-xl p-4 space-y-3">
        ...
        <ul className="space-y-2 text-sm text-gray-600">
          <li className="flex items-start gap-2">
            ...
            <span><strong>Automate research</strong> — Let agents gather and analyze information</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#8B5CF6] mt-0.5">•</span>
            <span><strong>Handle customer queries</strong> — Route and respond to customer requests automatically</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#8B5CF6] mt-0.5">•</span>
            <span><strong>Process documents</strong> — Extract and transform document data intelligently</span>
          </li>
        </ul>
      </div>
      ...
      >
        ...
        <p className="text-sm text-gray-500 mt-1">Configure your own agent settings</p>
      </button>

...
interface TooltipTextFieldProps {
  value: string;
...
export const TooltipTextField = ({
  ...
  return (
    <div className="flex flex-col gap-1" data-testid="v2-tooltip-text">
      <div className="flex items-center gap-1">
        <ODSLabel variant="body1">Tooltip Text</ODSLabel>
        {helpText && (
      ...
      <SettingsTextField
        ...
        onChange={onChange}
        dataTestId="v2-tooltip-text-input"
      />
    </div>
  );
};

...
const MultiQuestionPageSettings = ({ question, onChange }: MultiQuestionPageSettingsProps) => {
    ...
    <div className="space-y-4">
      ...
      >
        <div className="space-y-2">
          ...
          <HelperText>
            Text shown on the button to proceed to the next page
          </HelperText>
        </div>
      </SettingsCard>
      ...
      >
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="e.g., Answer all questions on this page"
            onChange={(e) => updateSettings("toolTipText", e.target.value)}
            data-testid="v2-multi-question-page-tooltip"
          />
          <HelperText>

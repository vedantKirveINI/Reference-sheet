        ...
        >
          ...
          <div className={styles.dataSection}>
            <div className={styles.dataBlock}>
              <span className={styles.dataLabel}>
                <Icon outeIconName="OUTEInputIcon" style={{ fontSize: "0.75rem" }} />
                Sample Input
              </span>
            ...
            <div className={styles.dataBlock}>
              <span className={styles.dataLabel}>
                <Icon outeIconName="OUTEOutputIcon" style={{ fontSize: "0.75rem" }} />
                Sample Output
              </span>
              <pre className={styles.dataCode}>
          ...
          <div className={styles.footer}>
            <span className={styles.hint}>
              <Icon outeIconName="OUTEKeyboardIcon" style={{ fontSize: "0.75rem" }} />
              Press Enter to add
            </span>
          </div>
        </motion.div>

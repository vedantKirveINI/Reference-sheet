...
import { ODSTooltip as Tooltip, ODSIcon as Icon } from "../../../../index.js";
import { Lock, Globe, Link, EyeOff } from "lucide-react";
...
const SourceTypeIndicator = ({ sourceType }) => {
  ...
  return (
    <div
      className={classes["source-type-indicator"]}
      style={{
...
const DataBlock = ({ block, startChars, endChars, sourceType, onClick = () => {} }) => {
  ...
  return (
    ...
    >
      ...
      >
        {sourceType && <SourceTypeIndicator sourceType={sourceType} />}

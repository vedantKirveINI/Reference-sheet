...
import {
  ...
  getComponentStyles,
} from "./phone-country-input-styles";
...
/**
 * Phone country + phone input. Mobile preview uses full-screen overlay (constrained to question filler).
 */
  ...
  return (
    <>
      {showBackdrop &&
        createPortal(
          <div
            ...
            data-testid="phone-number-mobile-backdrop"
          />,
      ...
      <div
        ...
        data-testid="country-input-root-for-PHONE"
      >
        <PhoneInputInner

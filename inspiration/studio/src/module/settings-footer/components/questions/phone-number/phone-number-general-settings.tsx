...
import { ODSTooltip as ODSToolTip } from "@src/module/ods";
import { OTP_SUPPORTED_COUNTRIES, SETTINGS_INPUT_NAMES,  } from "@oute/oute-ds.core.constants/constants";
...
const PhoneNumberSettings = ({
  ...
  return (
    <div style={styles.container} data-testid="phone-number-general-settings">

...
const DateAdvancedSettings = ({
  ...
  return (
    <div style={styles.container} data-testid="date-advanced-settings">
      ...
      <div
        style={{ ...styles.wrapperContainer, justifyContent: "space-between" }}
      >
        <div style={styles.inputContainer} data-testid="settings-start-date">
        ...
        <div style={styles.inputContainer} data-testid="settings-end-date">

...
import { DEFAULT_MAX_CURRENCY_VALUE, DEFAULT_MIN_CURRENCY_VALUE, REGEX_CONSTANTS,  } from "@oute/oute-ds.core.constants";
...
const CurrencySettings = ({
  ...
  return (
    <div style={styles.container} data-testid="currency-general-settings">
      ...
      <div style={styles.wrapperContainer}>
        <div style={styles.rangeContainer} data-testid="currency-range-container">

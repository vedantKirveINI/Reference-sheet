...
import { FormulaBar, ODSAutocomplete } from "@src/module/ods";
...
import { KeyValueGrid, TKeyValueRow, TKeyValueGridColumn } from "./key-value-grid";
import { FormulaCellEditor, FormulaCellRenderer } from "./key-value-grid/formula-cell";
...
export function KeyValueTableV2({
  ...
  const columns: TKeyValueGridColumn[] = [
    ...
    },
    {
      ...
      cellEditor: ({ data, rowIndex, onValueChange, placeholder }) => (
        <FormulaCellEditor
    ...
    <section>
      {isCreator && (
        <ODSAutocomplete
          ...
          onChange={async (_e: any, newValue: any) => {
            onChange("settings", {
              ...question?.settings,
              tableType: newValue,
            });
          }}
          isOptionEqualToValue={(option: any, _value: any) => option === _value}
...
export default KeyValueTableV2;

...
import useMCQFieldHandler from "./hooks/useMCQFieldHandler";
...
function MCQField({
	...
	const {
		...
		setSearchValue,
		handleSelectOption = () => {},
	} = useMCQFieldHandler({ value, onChange, field, fieldIndex });
	...
	return (
		...
		>
			<div
				className={`${styles.mcq_input_container} ${isOpen ? styles.selected : ""}`}
				data-testid="mcq-expanded-row"
			>

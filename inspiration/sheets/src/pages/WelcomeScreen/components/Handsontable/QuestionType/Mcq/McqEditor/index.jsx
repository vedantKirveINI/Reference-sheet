...
export default class McqEditor extends Handsontable.editors.TextEditor {
	...
	createElements() {
		const mcqNode = document.querySelector("#root-mcq-editor");
		if (mcqNode) return;
		...
		this.TEXTAREA_PARENT.setAttribute("id", "root-mcq-editor");

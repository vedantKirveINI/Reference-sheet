...
export default class RatingEditor extends Handsontable.editors.TextEditor {
	...
	createElements() {
		const ratingNode = document.querySelector("#root-rating-editor");
		...
		this.TEXTAREA_PARENT.setAttribute("id", "root-rating-editor");
	...
	setValue(ratingDetails) {
		this.originalValue = ratingDetails;
	}

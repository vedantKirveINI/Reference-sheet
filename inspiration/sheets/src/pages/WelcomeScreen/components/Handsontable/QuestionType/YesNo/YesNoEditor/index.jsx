...
export default class YesNoEditor extends Handsontable.editors.TextEditor {
	...
	createElements() {
		const yesNoNode = document.querySelector("#root-yes-no-editor");
		if (yesNoNode) return;
		...
		this.TEXTAREA_PARENT.setAttribute("id", "root-yes-no-editor");

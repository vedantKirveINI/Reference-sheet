...
export async function zipCodeCreateField({ page }) {
	await scrollRight({ page, n: 6 });
	...
	const colName = page
		...
		.getByTestId("column-zip-code-14")
		.locator("span");

	await expect(colName).toHaveText("Zip Code");
}

...
function PersonEnrichment(props, ref) {
  const {
    canvasRef,
    annotation,
    data,
    ...
    return [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          assetId: assetId,
          projectId: projectId,
          node: nodeData || PERSON_ENRICHMENT_NODE,
  ...
  return (
    <TabContainer
      ...
      colorPalette={{
        dark: PERSON_ENRICHMENT_NODE.dark,
        light: PERSON_ENRICHMENT_NODE.light,
        foreground: PERSON_ENRICHMENT_NODE.foreground,
      }}
      onSave={onSave}
      hasTestTab={PERSON_ENRICHMENT_NODE.hasTestModule}
...
export default forwardRef(PersonEnrichment);

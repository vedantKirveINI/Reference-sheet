...
function EmailEnrichment(props, ref) {
  const {
    canvasRef,
    annotation,
    data,
    ...
    return [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          assetId: assetId,
          projectId: projectId,
          node: nodeData || EMAIL_ENRICHMENT_NODE,
  ...
  return (
    <TabContainer
      ...
      colorPalette={{
        dark: EMAIL_ENRICHMENT_NODE.dark,
        light: EMAIL_ENRICHMENT_NODE.light,
        foreground: EMAIL_ENRICHMENT_NODE.foreground,
      }}
      onSave={onSave}
      hasTestTab={EMAIL_ENRICHMENT_NODE.hasTestModule}
...
export default forwardRef(EmailEnrichment);

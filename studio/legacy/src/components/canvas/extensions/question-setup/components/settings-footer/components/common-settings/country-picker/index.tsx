...
import { ODSAutocomplete as ODSAutoComplete, ODSCheckbox, ODSChip as Chip } from "@src/module/ods";
import { countryPickerStyles } from "./styles";
import {
  COUNTRY_SELECTION_FOR,
  INPUT_HEIGHT,
    ...
    if (multiple) {
      ...
      return (
        <li
          ...
          css={countryPickerStyles?.autocomplete?.option}
        ...
        >
          ...
          <span
            css={countryPickerStyles?.autocomplete?.option?.text({
              flex: 1,
            })}
          >
            {option?.countryName}
          ...
          {type === COUNTRY_SELECTION_FOR.PHONE && (
            <span css={countryPickerStyles?.autocomplete?.option?.text()}>

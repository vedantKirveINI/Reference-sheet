import { FIND_ALL_SHEET_RECORD_V2_TYPE } from "../../constants/types";
import { NODE_TEMPLATES } from "../../../templates/nodeTemplates";
import { SHEET_ERRORS } from "../../../utils/errorEnums";

const FIND_ALL_SHEET_RECORD_NODE_V2 = {
  cmsId: "find-all-sheet-record",
  _src: "https://cdn-v1.tinycommand.com/1234567890/1744179754650/FindAllSheetRecord.svg",
  name: "Find All Record",
  description: "",
  type: FIND_ALL_SHEET_RECORD_V2_TYPE,
...
export default FIND_ALL_SHEET_RECORD_NODE_V2;

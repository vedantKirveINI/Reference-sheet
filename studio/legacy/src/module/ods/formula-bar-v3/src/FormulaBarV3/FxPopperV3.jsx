...
import { ODSSwitch as Switch } from "../../../index.jsx";
...
import { searchAndConsolidate } from "../utils/search-utils";
import { cloneDeep } from "lodash";
import { FIELDS, NODE_VARIABLES } from "../constants/types";
import { filterDataForDisplay, processNodeVariablesForSchemaList } from "../utils/fx-utils";
import DataBlockV3 from "./DataBlockV3";
import { SchemaListV3 } from "./SchemaListV3";
...
const FxPopperV3 = forwardRef(({
  ...
  const getAllVisibleBlocks = useMemo(() => {
    ...
    return blocks;
  }, [filteredDataBlocks, allFxDataBlocks, categories]);
  ...
  const handleKeyDown = useCallback((e) => {
    ...
    return false;
  }, [getAllVisibleBlocks, highlightedIndex, onDataBlockClick]);

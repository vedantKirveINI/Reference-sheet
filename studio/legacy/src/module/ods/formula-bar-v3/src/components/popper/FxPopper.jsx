...
import AllFxDataBlocks from "../all-fx-data-blocks";
import FilteredFxDataBlocks from "../filtered-fx-data-blocks";
import { cloneDeep } from "lodash";
import { FIELDS } from "../../constants/types";
import { filterDataForDisplay } from "../../utils/fx-utils";
const FxPopover = ({
  searchText = "",
  showVariables = true,
  showArithmetic = true,

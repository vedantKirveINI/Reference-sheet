...
/**
 * Currency-specific container styles used only by the currency module.
 * Returns Tailwind className; optional style only for dynamic scalingFactor.
 */
...
export const getComponentStyles = (viewPort?: string): string => {
  ...
  return cn(
    "flex w-full min-w-0 items-center gap-[0.75em] overflow-hidden rounded-t-[0.75em]",

...
} from "../../utils/setFloatingElemPosition";
...
function TextFormatFloatingToolbar({
  ...
  }, [editor, isLink, onLinkEditModeChange]);
  ...
  useEffect(() => {
    const scrollerElem =
      getScrollContainer(anchorElem) ?? anchorElem.parentElement;
  ...
  return (
    <div
      ...
      className="lexical-text-format-popup"
      data-testid="lexical-text-format-popup"
    >
      {editor.isEditable() && (
        <>
          <Button
            ...
            className={cn(
              "h-8 w-8 p-1 rounded hover:bg-accent",
              isBold && "text-primary bg-accent"
            )}
          >
          ...
          <Button
            ...
            className={cn(
              "h-8 w-8 p-1 rounded hover:bg-accent",
              isItalic && "text-primary bg-accent"
            )}
          >

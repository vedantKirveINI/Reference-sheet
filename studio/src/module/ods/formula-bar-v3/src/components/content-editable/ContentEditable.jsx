...
const ContentEditable = forwardRef(
  (
    ...
    const calculateCursorIndexInContent = (range, contentEditableEl) => {
      if (!range || !contentEditableEl) return 0;
      
      let index = 0;
      const nodes = contentEditableEl.childNodes;
    ...
    const updateCursorPosition = () => {
      ...
      if (range) {
        ...
        const cursorIndex = calculateCursorIndexInContent(range, contentEditableRef.current);
        onCursorPositionChange(cursorIndex);
      }
    };

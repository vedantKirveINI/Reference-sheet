...
const EndingSettings = ({ onChange, question }: EndingSettingsProps) => {
  const settings = question?.settings;

  const showCTA = useMemo(() => {
    if (settings?.showCTA === undefined || settings?.showCTA === null) {
      return true;
    }
      ...
      <div style={styles.wrapperContainer}>
        ...
        <SwitchOption
          ...
          onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
            updateSettings("showCTA", event.target.checked)
          }
        />

...
import { CANVAS_MODE, CANVAS_MODES, ViewPort,  } from "@oute/oute-ds.core.constants";
...
const YesNoSettings = ({
  ...
  return (
    <div style={styles.container} data-testid="yes-no-general-settings">
      ...
      <div style={styles.wrapperContainer}>
        <div
          style={styles.defaultValueContainer}

...
import { HITL_TYPE, HITL_V2_TYPE } from "../components/canvas/extensions";
...
export const useUpdateHITLNode = (canvasRef) => {
  const updateHITLData = (fromNode, toNode, newNode, link) => {
    ...
    try {
      const isHITLNode = fromData.type === HITL_TYPE || fromData.type === HITL_V2_TYPE;
      if (

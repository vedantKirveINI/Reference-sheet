...
function getStaticSuggestions(context, availableNodes) {
  ...
  const STATIC_SUGGESTIONS = {
    HTTP: ["TRANSFORMER", "IFELSE_V2", "UPSERT", "SEND_EMAIL"],
    FIND_ALL: ["ITERATOR", "TRANSFORMER", "IFELSE_V2", "AGGREGATOR"],
    FIND_ONE: ["IFELSE_V2", "TRANSFORMER", "UPDATE", "SEND_EMAIL"],
    ITERATOR: ["IFELSE_V2", "TRANSFORMER", "UPSERT", "AGGREGATOR"],
    TRANSFORMER: ["IFELSE_V2", "HTTP", "UPSERT", "SEND_EMAIL"],
    IFELSE_V2: ["HTTP", "SEND_EMAIL", "UPSERT", "TRANSFORMER"],
    FORM_TRIGGER: ["TRANSFORMER", "IFELSE_V2", "SEND_EMAIL", "UPSERT"],
    TABLE_TRIGGER: ["TRANSFORMER", "IFELSE_V2", "SEND_EMAIL", "HTTP"],
    SCHEDULE_TRIGGER: ["FIND_ALL", "HTTP", "SEND_EMAIL", "TRANSFORMER"],
    WEBHOOK: ["TRANSFORMER", "IFELSE_V2", "HTTP", "UPSERT"],
    TINY_GPT: ["TRANSFORMER", "SEND_EMAIL", "UPSERT", "HTTP"],
    SEND_EMAIL: ["DELAY", "IFELSE_V2", "UPSERT"],
    UPSERT: ["IFELSE_V2", "SEND_EMAIL", "HTTP"],
    CREATE: ["IFELSE_V2", "SEND_EMAIL", "TRANSFORMER"],
    UPDATE: ["IFELSE_V2", "SEND_EMAIL", "TRANSFORMER"],
  };

  const DEFAULT_SUGGESTIONS = hasTrigger 
    ? ["HTTP", "TRANSFORMER", "IFELSE_V2", "FIND_ALL", "SEND_EMAIL"]
    : ["FORM_TRIGGER", "SCHEDULE_TRIGGER", "HTTP", "TRANSFORMER", "IFELSE_V2"];

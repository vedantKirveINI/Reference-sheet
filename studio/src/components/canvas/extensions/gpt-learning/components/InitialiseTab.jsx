...
import { HelpCircle, Lightbulb, BookOpen, GraduationCap } from "lucide-react";
    ...
    <div className="space-y-8 p-6">
      <div className="text-center space-y-4">
        <div className="mx-auto w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center shadow-lg">
          <img src={extensionIcons.tinyGptLearning} alt="GPT Learning" className="w-10 h-10" />
        </div>
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">GPT Learning</h2>
      ...
      <div className="bg-green-50 rounded-xl p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <UseCaseItem icon={HelpCircle} text="Create quizzes" />
          <UseCaseItem icon={Lightbulb} text="Explain concepts" />
          <UseCaseItem icon={BookOpen} text="Build study guides" />
          <UseCaseItem icon={GraduationCap} text="Design lessons" />
        </div>
      </div>

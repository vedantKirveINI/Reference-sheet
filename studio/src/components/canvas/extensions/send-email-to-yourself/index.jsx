  ...
  (
    ...
    const saveHandler = useCallback(
      (openNodeAfterCreate = true) => {
        ...
        onSave(nodeDataResult, {}, openNodeAfterCreate);
      },
      [onSave, ref]
    );
    ...
    return (
      <ExtensionShell
        ...
        title={{
          ...
          foreground: nodeData?.foreground || SEND_EMAIL_TO_YOURSELF_NODE.foreground,
          background: nodeData?.background || SEND_EMAIL_TO_YOURSELF_NODE.background,

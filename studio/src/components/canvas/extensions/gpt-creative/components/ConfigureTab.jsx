    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <FormSection
          ...
          description="Define the creative writer's style and tone"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., You are a creative copywriter that writes engaging content..."
        ...
        <FormSection
          ...
          description="Describe what content to generate"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., Write compelling marketing copy for..."
        ...
        <FormSection
          title="Output Schema"
          description="Define the structure of the generated content"
          required

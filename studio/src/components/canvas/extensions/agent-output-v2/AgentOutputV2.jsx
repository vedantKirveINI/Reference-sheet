...
import { AGENT_OUTPUT_V2_NODE } from "./constants";
import { useAgentOutputState } from "./hooks/useAgentOutputState";
import InitialiseTab from "./components/InitialiseTab";
import ConfigureTab from "./components/ConfigureTab";

const AgentOutputV2 = forwardRef(
  (
    {
      canvasRef,
      annotation,
    ...
    const state = useAgentOutputState(data);
    ...
    const tabs = [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          parentId,
          variables,
          node: nodeData || AGENT_OUTPUT_V2_NODE,
    ...
    return (
      <TabContainer
        ...
        tabs={tabs}
        colorPalette={{
          dark: AGENT_OUTPUT_V2_NODE.dark,
          light: AGENT_OUTPUT_V2_NODE.light,
          foreground: AGENT_OUTPUT_V2_NODE.foreground,
        }}
        onSave={onSave}
        hasTestTab={AGENT_OUTPUT_V2_NODE.hasTestModule}

...
const TinyGPTWriterV2 = forwardRef(
  (
    {
      canvasRef,
      annotation,
    ...
    const state = useWriterState(data);
    ...
    const tabs = [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          parentId,
          variables,
          node: nodeData || TINYGPT_WRITER_V2_NODE,
    ...
    return (
      <TabContainer
        ...
        tabs={tabs}
        colorPalette={{
          dark: TINYGPT_WRITER_V2_NODE.dark,
          light: TINYGPT_WRITER_V2_NODE.light,
          foreground: TINYGPT_WRITER_V2_NODE.foreground,
        }}
        onSave={onSave}
        hasTestTab={TINYGPT_WRITER_V2_NODE.hasTestModule}
...
export default TinyGPTWriterV2;

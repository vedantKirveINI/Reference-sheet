...
import { AGENT_INPUT_V2_NODE } from "./constants";
import { useAgentInputState } from "./hooks/useAgentInputState";
import InitialiseTab from "./components/InitialiseTab";
import ConfigureTab from "./components/ConfigureTab";

const AgentInputV2 = forwardRef(
  (
    {
      canvasRef,
      annotation,
    ...
    const state = useAgentInputState(data);
    ...
    const tabs = [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          parentId,
          variables,
          node: nodeData || AGENT_INPUT_V2_NODE,
    ...
    return (
      <TabContainer
        ...
        tabs={tabs}
        colorPalette={{
          dark: AGENT_INPUT_V2_NODE.dark,
          light: AGENT_INPUT_V2_NODE.light,
          foreground: AGENT_INPUT_V2_NODE.foreground,
        }}
        onSave={onSave}
        hasTestTab={AGENT_INPUT_V2_NODE.hasTestModule}

...
// import CollapsibleSortSection from "../../common-components/CollapsibleSortSection"; // Sort commented out
        ...
        <>
          <div className="space-y-3">
            <Label className="text-sm font-medium text-gray-900">
              Find record where...<span className="text-red-500">*</span>
            </Label>
          ...
          */}
          ...
          <div className="space-y-3">
            ...
            <SheetUpdateGrid
              ...
              variables={variables}
              data-testid="update-sheet-record-grid"
            />

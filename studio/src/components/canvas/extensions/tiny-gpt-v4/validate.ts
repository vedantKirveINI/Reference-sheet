...
export const validateTinyGPT = (data: TinyGPTData): ValidationResult => {
...
export const normalizeOutputSchema = (schema: OutputSchemaField[]): OutputSchemaField[] => {
  if (!Array.isArray(schema)) {
    return [{ id: "field-default", key: "response", type: "string", required: true }];
  }
...
export default validateTinyGPT;

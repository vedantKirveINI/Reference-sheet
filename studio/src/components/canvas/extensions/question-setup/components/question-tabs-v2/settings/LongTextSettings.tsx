...
const LongTextSettings = ({
  ...
  const handleCharacterLimit = (type: "min" | "max", value: string) => {
    ...
    if (value === "") {
      updateSettings(
        type === "min" ? CHARACTERS.MIN_CHAR : CHARACTERS.MAX_CHAR,
        value,
        {
          charLimitError: "",
        }
    ...
    <div className="space-y-4">
      ...
      >
        <div className="space-y-2">
          <SettingSwitch
            label="Required"
            description="Users must enter text before submitting"
            checked={settings?.required || false}
            onChange={(checked) => updateSettings("required", checked)}
            dataTestId="v2-long-text-required"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <DefaultValueFx
            ...
            dataTestid="v2-long-text-default-value"
            hideLabel
          />
          <HelperText>
            Pre-fill this field with text when the form loads
          </HelperText>
        </div>
      ...
      >
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              data-testid="v2-long-text-min-char"
              className="w-20"
            />
            ...
            <Input
              ...
              data-testid="v2-long-text-max-char"
              className="w-20"
            />
            <span className="text-sm text-muted-foreground whitespace-nowrap">
              characters
          ...
          {settings?.errors?.charLimitError ? (
            ...
            <HelperText>
              Limit how many characters users can type
            </HelperText>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            data-testid="v2-long-text-format"
          >
            <SelectTrigger>
      ...
      >
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="e.g., Please provide detailed feedback"
            onChange={(e) => updateSettings("toolTipText", e.target.value)}
            data-testid="v2-long-text-tooltip"
          />
          <HelperText>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              data-testid="v2-long-text-access-key"
              className="flex-1"
            />
            {settings?.accessKey && (
              <Button

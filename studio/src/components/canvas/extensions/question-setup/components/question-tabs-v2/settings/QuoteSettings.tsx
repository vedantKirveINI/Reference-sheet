...
const QuoteSettings = ({ question, onChange }: QuoteSettingsProps) => {
      ...
      >
        ...
        <div className="space-y-2">
          <SettingSwitch
            ...
            checked={settings?.quotationMark ?? true}
            onChange={(checked) => updateSettings("quotationMark", checked)}
            dataTestId="v2-quote-quotation-mark"
          />
        </div>
      </SettingsCard>
      ...
      >
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="e.g., Read the quote below"
            onChange={(e) => updateSettings("toolTipText", e.target.value)}
            data-testid="v2-quote-tooltip"
          />
          <HelperText>

...
export const FieldRenderer = ({
  ...
  const renderField = (field: FieldConfig) => {
    switch (field.type) {
      ...
      case FieldType.SHOW_CTA:
        return (
          <SwitchField
            key={field.type}
            title="Show CTA"
            checked={
              settings?.showCTA === undefined || settings?.showCTA === null
                ? true
                : settings?.showCTA
            }
      ...
      case FieldType.ADDRESS_FIELDS:
        return (
          <div key={field.type} className="p-3 bg-[#f5f5f5] rounded text-[#757575] text-[13px] text-center">
  ...
  return (
    <div className="flex flex-col gap-4" data-testid="field-renderer">

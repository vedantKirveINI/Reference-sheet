...
export const AutocompleteTrigger = ({
  ...
  const renderChip = (value: any) => (
    <span style={styles.autocomplete.chip}>
  ...
  const renderChips = (): React.ReactNode => {
    ...
    return (
      <span style={styles.selectedOptions} data-testid="selected-options">
  ...
  const renderTooltipContent = (): React.ReactNode => {
    ...
    return (
      <div style={styles.tooltipContainer} data-testid="tooltip-container">
    ...
    <>
      <Tooltip title={renderTooltipContent()} placement="bottom-start">
        <div
          ...
          style={(styles.autocompleteTriggerContainer({
            isActive: false,
            viewPort,
            style,
          })}

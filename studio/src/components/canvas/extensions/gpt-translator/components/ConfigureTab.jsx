    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <FormSection
          ...
          description="Define the translator's behavior and style"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., You are a professional translator that maintains the original tone..."
        ...
        <FormSection
          ...
          description="Specify what to translate and to which language"
          required
        ...
        <FormSection
          title="Output Schema"
          description="Define the structure of the translation output"
          required
            ...
            <div className="mt-4 space-y-4 p-4 bg-gray-50 rounded-xl">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  Lower values produce more consistent translations
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-400">
                  Maximum length of the translation output
                </p>
              </div>
            </div>
          )}

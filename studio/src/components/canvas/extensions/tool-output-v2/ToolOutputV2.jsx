...
const ToolOutputV2 = forwardRef(
  (
    ...
    const state = useToolOutputState(data);
    ...
    const tabs = [
      ...
      },
      {
        ...
        panelComponentProps: {
          ...
          parentId,
          variables,
          node: nodeData || TOOL_OUTPUT_V2_NODE,
    ...
    return (
      <TabContainer
        ...
        tabs={tabs}
        colorPalette={{
          dark: TOOL_OUTPUT_V2_NODE.dark,
          light: TOOL_OUTPUT_V2_NODE.light,
          foreground: TOOL_OUTPUT_V2_NODE.foreground,
        }}
        onSave={onSave}
        hasTestTab={TOOL_OUTPUT_V2_NODE.hasTestModule}

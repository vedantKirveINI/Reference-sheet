    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <FormSection
          ...
          description="Define how the AI should summarize content"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., You are a skilled summarizer that creates concise summaries..."
        ...
        <FormSection
          ...
          description="What should the AI summarize? Use {{data}} to insert variables"
          required
        ...
        >
          <FormulaBar
            variables={variables}
            wrapContent
            placeholder="e.g., Summarize the following content into key bullet points..."
        ...
        <FormSection
          title="Output Schema"
          description="Define what summary fields the AI should return"
          required
            ...
            <div className="mt-4 space-y-4 p-4 bg-gray-50 rounded-xl">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  Lower values = more precise summaries, higher values = more creative language
                </p>
              </div>
